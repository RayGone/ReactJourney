const ProductCard = () => 
  <div className="w-full flex flex-row justify-center dark:bg-gray-900/70 select-none">
    <div className="w-[85%] lg:w-[75%] m-4 flex flex-col lg:flex-row bg-gray-50 dark:bg-gray-950 dark:shadow-black/60 border-t-1 shadow-gray-900 shadow-sm rounded rounded-t-none">
      <div className="dark:bg-gray-900 flex flex-col h-full align-middle p-4">
      ...
      <img className="w-full border-1 border-gray-600 rounded rounded-t-none lg:w-[60%]" src="exitl.png" alt="Car" />
    </div>
  </div>;
